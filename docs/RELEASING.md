...
Build, publication, and acceptance procedures for maintainers. The product contract is [`PiPlay_Product_Engineering_Spec.md`](PiPlay_Product_Engineering_Spec.md) (section 21 owns the packaging rules); users start from the [README](../README.md).

## Machines and promotion
